...
export default function App() {
  ...
  const handleLogin = () => {
    if (homeMode === "admin") {
      const isSuper   = loginPw === superPw && loginUser === "";
      const userMatch = users.find(u => u.name===loginUser && u.password===loginPw);
  ...
  const createEvent = () => {
    ...
    const ev = {
      ...
      scheduledFor: nStartMode==="scheduled"?parseDT(nSchedDate,nSchedTime):null,
